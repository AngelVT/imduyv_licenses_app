    ...
    const definition = {
        ...
        content: [
            ...
            },*/
            {
                ...
                table: {
                    widths: ['*'],
                    body: await docUtils.loadChartXHTML(lcDBObj.fullInvoice, 'tablas_2.xhtml', 6, "RESUMEN DE MANZANAS")
                },
                layout: docUtils.noBorderNoPadding
            },
            /*{
            ...
            },*/
            {
                ...
                table: {
                    widths: ['*'],
                    body: await docUtils.loadChartXHTML(lcDBObj.fullInvoice, 'tablas_3.xhtml', 6, "RESUMEN DE LOTES POR USO")
                },
                layout: docUtils.noBorderNoPadding
            },
            /*{
